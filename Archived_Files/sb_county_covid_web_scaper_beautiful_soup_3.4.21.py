...
index = -1
while dates[index + 1].text.strip() != 'February 23, 2021':      #the website format recently changed to include an archive section after the Feb. 23, 2021 data was uploaded
...
cases_by_area_hist = pd.read_csv('cases_by_area_2.23.csv')
...
recovery_status_hist = pd.read_csv('recovery_status_2.23.csv')
...
cases_by_age_hist = pd.read_csv('cases_by_age_2.23.csv')
...
cases_by_gender_hist = pd.read_csv('cases_by_gender_2.23.csv')
...
testing_status_hist = pd.read_csv('testing_status_2.23.csv')
...
transmission_method_hist = pd.read_csv('transmission_method_2.23.csv')
...
ethnicity_hist = pd.read_csv('ethnicity_2.23.csv')
